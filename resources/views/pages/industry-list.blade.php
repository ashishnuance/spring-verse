            ...
            <div class="col s12">
              ...
              <table id="page-length-option" class="display">
                ...
                <tbody>
                  ...
                  @foreach($industrylist as $k=>$list)
                  ...
                  <tr>
                    ...
                    <td>
                      @if($list->status ==1)
                      <a href="{{route('industry-status', ['id'=>$list->id,'status'=>0])}}" class="btn btn-danger">Inactive</a>
                      @elseif($list->status ==0)
                      <a href="{{route('industry-status', ['id'=>$list->id,'status'=>1])}}" class="btn btn-success">Active</a>
                      @endif
                      ...
                      <a href="{{route('industry.edit',[$list->id])}}" class="btn btn-success"><i class="material-icons dp48">edit</i></a>
