              ...
              <table id="page-length-option" class="display">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$list->patner_location}}</td>


                    <td>
                    
                    <img src="{{ url('/').'/assets/uploadimage/'.$list->logo }}" class="responsive-img" width="100" height="100" alt="">
                    ...
                    <td>
                      @if($list->status ==1)
                      <a href="{{route('patner-status', ['id'=>$list->id,'status'=>0])}}" class="btn btn-danger">Inactive</a>
                      @elseif($list->status ==0)
                      <a href="{{route('patner-status', ['id'=>$list->id,'status'=>1])}}" class="btn btn-success">Active</a>
                      @endif
                      ...
                      <a href="{{route('patner_edit', ['id'=>$list->id])}}" class="btn btn-success"><i class="material-icons dp48">edit</i></a>
