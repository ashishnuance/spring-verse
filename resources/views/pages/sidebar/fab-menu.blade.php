<div style="bottom: 50px; right: 19px; display:none;" class="fixed-action-btn direction-top"><a
    ...
    <ul>
        ...
        <li><a href="{{asset('app-email')}}" class="btn-floating red"><i class="material-icons">mail_outline</i></a>
        </li>
    </ul>
</div>